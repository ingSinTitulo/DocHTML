...
- The fundamental pieces in HTML are called [tags](/first-steps/tags.md) and they follow a very well defined set of rules to be created (Notice that HTML tag is not the same as HTML element even though they are sometimes used interchangeably by mistake).
- All HTML elements have [attributes](/first-steps/attributes.md) that modify their behaviour, and there are a set of [global attributes](/first-steps/global-attributes.md) that apply to all elements.
